...
- [🧠 DEVBOOK — Living Developer Knowledge Base](#-devbook--living-developer-knowledge-base)
  ...
  - [🌐 Global Rules (All Projects)](#-global-rules-all-projects)
    - [1. Database \& Backend (Supabase)](#1-database--backend-supabase)
      - [Schema Design](#schema-design)
      - [Row Level Security (RLS)](#row-level-security-rls)
      - [Supabase Client](#supabase-client)
    - [2. Storage \& File Uploads](#2-storage--file-uploads)
      - [Bucket Setup](#bucket-setup)
      - [Upload Flow (Critical Pattern)](#upload-flow-critical-pattern)
    ...
    - [4. Form \& Input Handling](#4-form--input-handling)
      ...
      - [Validation Before Save](#validation-before-save)
      - [Save Button States](#save-button-states)
    - [5. CRUD Operations](#5-crud-operations)
      - [Optimistic UI Updates](#optimistic-ui-updates)
      - [Delete Flow](#delete-flow)
      - [Add New Item Flow](#add-new-item-flow)
    - [6. UI/UX Standards](#6-uiux-standards)
      - [Design Philosophy](#design-philosophy)
      - [Modal Design Pattern](#modal-design-pattern)
  ...
  - [🍕 App-Specific: Food Delivery / Cloud Kitchen](#-app-specific-food-delivery--cloud-kitchen)
    - [Core Features Checklist](#core-features-checklist)
      - [Customer-Facing (Priority Order)](#customer-facing-priority-order)
      - [Admin Portal (Priority Order)](#admin-portal-priority-order)
    - [Database Schema Patterns](#database-schema-patterns)
      - [`menu_items` Table](#menu_items-table)
      - [`orders` Table](#orders-table)
      - [`order_items` Junction Table](#order_items-junction-table)
    - [Admin Portal Rules](#admin-portal-rules)
      - [Menu Manager Behavior](#menu-manager-behavior)
      - [Order Manager Behavior](#order-manager-behavior)
    - [Customer-Facing Rules](#customer-facing-rules)
      - [Food Card Component](#food-card-component)
      - [Cart](#cart)
    - [Image Management Rules](#image-management-rules)
    - [Order Flow](#order-flow)
  - [📋 App-Specific: Task Manager (Template)](#-app-specific-task-manager-template)
    - [Core Features Checklist](#core-features-checklist-1)
    - [Database Schema Patterns](#database-schema-patterns-1)
    - [UI Rules](#ui-rules)
